 ...
 */
export declare function trimAndCollapseSpaces(text: string): string;
/**
 * Whether the given value is a valid NAG or not.
 */
export declare function isValidNag(nag: unknown): boolean;
/**
 * Whether the given value is a valid NAG or not.
 */
export declare function isValidElo(elo: unknown): boolean;
/**
 * Whether the given value is a valid round (or sub-round, or sub-sub-round...) or not.
 */
export declare function isValidRound(round: unknown): boolean;
