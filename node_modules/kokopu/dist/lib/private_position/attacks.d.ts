 ...
 */
export declare const ATTACK_DIRECTIONS: number[][];
/**
 * Check if any piece of the given color attacks a given square.
 */
export declare function isAttacked(position: PositionImpl, square: number, attackerColor: number): boolean;
/**
 * Return the squares from which a piece of the given color attacks a given square.
 */
export declare function getAttacks(position: PositionImpl, square: number, attackerColor: number): number[];
