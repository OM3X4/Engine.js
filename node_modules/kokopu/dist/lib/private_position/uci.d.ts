 ...
 */
export declare function getUCINotation(position: PositionImpl, descriptor: MoveDescriptorImpl, forceKxR: boolean): string;
/**
 * Parse a UCI notation for the given position.
 */
export declare function parseUCINotation(position: PositionImpl, notation: string, strict: boolean): MoveDescriptorImpl;
